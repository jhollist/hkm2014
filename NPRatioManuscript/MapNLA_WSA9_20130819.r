v<-'MapNLA_WSA9_20130819.r' #name of the rscript
...
my.palette<-brewer.pal(10,"Set3")
PtColors<-c('black')  #2007 and 2012 point colors
...
tiff("NLA_data.tif",width=9.19,height=6.83,unit="in",res=300) 
plot(WSA9Alb,col=my.palette,border=NA,axes=F,xlim=c(-2800000,2000000))   #plot ecoregions
  plot(StatesAlb,border="gray",add=T)                                                 #add state boundaries
  points(Alb2007,pch=24,col=PtColors,bg="black",cex=PtSize[1])         #add 2007 NLA sites
  points(Alb2012,pch=25,col=PtColors,bg="black",cex=PtSize[2])          #add 2012 NLA sites
#Add legends
legend('topleft',WSA,pch=15,col=my.palette[-1],bty='n',title='Ecoregion')  #ecoregion
legend('bottomleft',legend=c(2007,2012),pch=c(24,25),col=PtColors,pt.bg="black",bty='n',title='Year') #NLA locations by year
