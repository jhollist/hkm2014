...
gisPerc_varsel<-varSelRF(gisVarDF[,1:dim(gisVarDF)[2]-1],gisVarDF[,respName],ntree = 100, ntreeIterat = 50,
												 vars.drop.frac = 0.2)
gisPerc_varsel_boot<-varSelRFBoot(gisVarDF[,1:dim(gisVarDF)[2]-1],gisVarDF[,respName],bootnumber=10,
																	usingCluster=F,srf=gisPerc_varsel)
