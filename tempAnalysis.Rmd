...
For the Random Forest analysis we need a response variable.  For now just just the TS_CHLA.  
...
### Analysis:  Run varSelRF multiple time to see if the same variables are selected each time.
...
#run for all GIS predictors
	#intial conditions:
		...
		dropFrac<-0.1 #(0.2) proportion of variable to drop after each iteration
	
	#select complete cases
		keep<-complete.cases(Pgis,TS_CHLA)
	#run rf
		GIS_1<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_2<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_3<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_4<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_5<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_6<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_7<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_8<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_9<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
		GIS_10<-varSelRF(Pgis[keep,],hkm2014Data[keep,'TS_CHLA'],ntree = NTREE, ntreeIterat = Niterations, vars.drop.frac = dropFrac)
```
